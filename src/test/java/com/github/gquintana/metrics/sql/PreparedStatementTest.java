...
public class PreparedStatementTest {
    ...
    public void testPreparedStatementLife() throws SQLException {
        ...
        assertThat(metricRegistry.getTimers().get("java.sql.PreparedStatement.[select * from metrics_test]")).isNotNull();
    ...
    public void testPreparedStatementExec() throws SQLException {
        ...
        assertThat(metricRegistry.getTimers().get("java.sql.PreparedStatement.[select * from metrics_test].exec")).isNotNull();
    ...
    public void testPreparedStatementExecSide() throws SQLException {
        ...
        // Assert
        assertThat(connection).isNotNull();
        assertThat(metricRegistry.getTimers().get("java.sql.PreparedStatement.[select * from metrics_test order by created desc].exec")).isNotNull();
    ...
    public void testPreparedStatementExec_Direct() throws SQLException {
        ...
        assertThat(connection).isNotNull();
        assertThat(Proxy.isProxyClass(resultSet.getClass())).isTrue();
        assertThat(metricRegistry.getTimers().get("java.sql.PreparedStatement.[select * from metrics_test order by id].exec").getCount()).isEqualTo(1);
    }
